...
const playSong = (id) => {
  ...
  // Update the appearance of the playButton element
  ...
  // Play the song
  const audio = document.getElementById('audioElement') // Assuming the audio element has this ID
  if (audio) {
    audio.src = song.url // Set the source of the audio element to the song URL
